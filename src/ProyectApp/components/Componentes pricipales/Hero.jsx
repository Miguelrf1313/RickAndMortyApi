...
export const Hero = () => {
  ...
  return (
        ...
        <Grid  sx={{
            ...
            <Grid sx={{width:'51%', padding:'20px', display:'flex', justifyContent:'space-between', alignItems:'center', flexDirection:'column' }} >

                    <Grid component='div' sx={{ width:'100%', padding:'20px', height:'200px', alignItems:'center',justifyContent:'center',  backgroundPosition:'center', display:'flex',  }}>
                ...
                <Grid component='div' sx={{}}>
                    ...
                    <Grid item sx={{color:'white', width:'50%', padding:'20px',display:'flex', flexDirection:'row', justifyContent:'space-around'}}>
                        ...
                        <Grid item sx={{ width:'50%', height:'10vh', display:'flex',justifyContent:'center',alignItems:'center', paddingLeft:'10px'}}>
                            <Grid  sx={{padding:'20px',display:'flex', }} >
                                <Button onClick={loadingActive} sx={{background:'linear-gradient( to left, rgba(116, 9, 121, 1), rgba(185, 8, 246, 1), rgba(91, 28, 230, 1) )', borderRadius: '30px', color:'white', fontWeight:'bolder',fontSize:'1.5rem', width:'500px', height:'70px'}} variant='contained' color='error' >¡Iniciar ahora!</Button>
                            </Grid>
