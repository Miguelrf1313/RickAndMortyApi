...
export const HeroCards = () => {
   ...
   <Box sx={{width:'50%', position:'absolute', left:'25%', top:'25%',  padding:'20px', flexDirection:'column' }} >
...
<Box component='div' hidden={true} sx={{position:'absolute', top:'60%', left:'25%'}}>
